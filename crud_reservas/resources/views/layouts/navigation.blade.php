<nav x-data="{ open: false }" class="border-gray-700 fixed w-full top-0 z-50" style="background-color: #A67B5B;">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-auto">
                <div class="space-x-8">
                    ...
                    <a href="#equipe" class="text-white no-underline hover:text-gray-300">Sobre</a>
                ...
                @if (Auth::check())
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        ...
                        <x-responsive-nav-link :href="route('logout')"
                                onclick="event.preventDefault();
                                    this.closest('form').submit();" class="text-white no-underline">
                            {{ __('Log Out') }}
                        </x-responsive-nav-link>
                    </form>
                @else
